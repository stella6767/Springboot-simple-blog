              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="/image/myface.jpg" alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
                      <h4>강민규</h4>
              ...
              <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-secondary">﻿http://ec2-13-59-222-78.us-east-2.compute.amazonaws.com:8080/</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
